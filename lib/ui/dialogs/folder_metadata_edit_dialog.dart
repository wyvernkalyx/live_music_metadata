...
/// Simple model class to hold metadata for a single folder.
/// This can map to your ConversionMetadata or partial of it.
...
class FolderMetadataEditDialog extends StatefulWidget {
  ...
  @override
  State<FolderMetadataEditDialog> createState() => _FolderMetadataEditDialogState();
}
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const Text('Create Backup for this folder'),
              ],
            ),
          ],
        ),
